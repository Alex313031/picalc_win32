#ifndef PICALCWIN32_VERSION_H_
#define PICALCWIN32_VERSION_H_
...
#define APP_NAME        L"PiCalc Win32"   // Name of the App
#define MAIN_WNDCLASS   L"PicalcWin32" // Our main Window Class unique name

#define COMMENTS        L"https://github.com/Alex313031/picalc_win32" // Project GitHub URL
#define COMPANYNAME     L"Alex313031" // My developer name
#define FILE_DESCRIPT   L"Pi Calculator for Win32" // File description
#define INTERNAL_NAME   L"picalc" // "Internal" name, also used for .exe name
...
#define ABOUT_CONTENT   L"PiCalc for Windows"
